...
const LAND = {
  pl: [
    'Wieczorem {in} auto stanęło. Zadzwoniłem do INNSER, dyspozytor od razu podał cenę, holownik był szybko. Odholowali spokojnie — polecam.',
    'Rano {in} nie odpaliłem. Myślałem, że skończy się na kablach, ale potrzebna była laweta. INNSER przyjechał, załadowali bez szarpania.',
    'Po stłuczce {in} panikowałem. Dyspozytor INNSER uspokoił, pomoc drogowa dojechała, auto pojechało na serwis. Dzięki.',
    ...
    'Szukałem holownika koło {gen} w weekend. INNSER odebrał od razu, dyspozytor konkretny, przyjechali i załatwili.',
    '{in|cap} złapałem awarię skrzyni. Laweta INNSER — szybko, uczciwie, zero kombinowania.',
    'Zablokowałem przejazd {in}, wstyd. Holownik INNSER przyjechał bez dramatu, zdjął auto i po sprawie.',
    'Potrzebowałem pomocy drogowej z osiedla {in}. Dyspozytor zapytał o dojazd, kierowca znał okolicę — INNSER plus.',
    'Deszcz, {place}, auto zgasło. Pomoc drogowa INNSER: telefon, wycena, dojazd. Holownik zrobił robotę.',
    '{in|cap} pękła opona i nie miałem zapasu. Najpierw myśleli o kole, skończyło się na lawecie INNSER — OK.',
    'Sobota {in}, auto na awaryjnych. INNSER: dyspozytor spokojny, holownik szybko, cena bez niespodzianek.',
    'Musiałem zabrać auto z parkingu {in}. INNSER ogarnął, załadowali ostrożnie. Polecam ten numer.',
    'Awaria klimatyzacji? Nie — silnik. {in|cap} wezwałem INNSER. Laweta, warsztat, wszystko w jednym ciągu.',
    'Przyjaciel utknął {in}. Zadzwoniłem za niego do INNSER — pomoc drogowa pojechała, potem podziękował. Działa.',
    'Zimą {in} akumulator padł totalnie. Na miejscu nie dało rady, holownik INNSER zawiózł do serwisu.',
    ...
    'Auto nie chciało jechać pod górkę {in}. Wezwałem lawetę INNSER — szybko i bez stresu.',
    'Dyspozytor INNSER znał {place}, nie dopytywał sto razy. Holownik przyjechał, załadunek czysty. Polecam.',
    'Wieczór {in}, kontrolka silnika i postój. Pomoc drogowa INNSER — laweta zamiast kombinowania na własną rękę.',
    '{in|cap} urwał się przegub. INNSER: telefon → dojazd → platforma. Bez gadania, konkret.',
    'Żona stała {in} z dzieckiem. Zadzwoniłem do INNSER — pomoc drogowa szybko, kierowca miły. Ulga.',
    'Po pracy {in} auto „umrzeć”. INNSER odholował do domu warsztatu partnerskiego. Super sprawa.',
    'Myślałem, że {in} długo poczekam. A INNSER był szybciej niż myślałem. Holownik + jasna cena.',
    '{in|cap} potrzebowałem holownika pod konkretny adres serwisu. INNSER dowiózł dokładnie tam. OK.',
    'Pierwszy raz wzywałam lawetę — akurat {in}. Dyspozytor INNSER wytłumaczył krok po kroku. Spokojnie.',
    'Auto po awarii elektryki {in}. INNSER zabrał lawetą, bez problemu.',
    '{in|cap} stałem na zakazie. Lepiej wezwać holownika niż mandat w nieskończoność — INNSER załatwił.',
    'Nocny dyżur {in}: INNSER wziął telefon, wysłał holownik. Cena taka, jak w rozmowie. Szacun.',
    'Zepsuł się turbo {in}. Nie ryzykowałem jazdy — pomoc drogowa INNSER. Dobrze, że zadzwoniłem.',
    ...
    '{in|cap} auto zablokowało wjazd do bramy. Holownik INNSER zdjął je ostrożnie, bez rys na bramie.',
...
const ROAD = {
  pl: [
    'Awaria na {place}, stanąłem na poboczu. INNSER — dyspozytor od razu, laweta szybko, załadunek bez szarpania.',
    'Na {place} o 2 w nocy. Pomoc drogowa INNSER odebrała, holownik dojechał, cena jak w telefonie.',
    'Pękła opona na {place}, brak miejsca na bezpieczną wymianę. Wezwałem pomoc drogową INNSER — dobra decyzja.',
    'Kontrolka i utrata mocy na {place}. Nie ryzykowałem dojazdu — holownik INNSER zabrał do serwisu.',
    'Deszcz, {place}, awaria. Dyspozytor INNSER podał ETA, laweta zjawiła się w terminie. Polecam.',
    'Na {place} po kolizji. INNSER zabezpieczył temat: dojazd, załadunek, warsztat. Spokój.',
    'Auto nie ciągnęło na {place}. Laweta INNSER — szybko zjechali z trasy i pojechali dalej ze mną na platformie.',
    ...
    'Zimą na {place} poślizg i awaria. Holownik INNSER, kierowca ostrożny. Dzięki.',
    'Skonczył się paliwowy dramat na {place}? Nie — padł silnik. INNSER odholował bez dyskusji.',
    'Na {place} w korku + awaria. Dyspozytor INNSER wiedział, jak podjechać. Holownik dał radę.',
    ...
    'Na {place} po burzy, zalane? Nie, po prostu zgasło. Pomoc drogowa INNSER — laweta i serwis.',
    'Zjechałem na pobocze {place} z awarią ABS/silnika. INNSER: jasna cena, szybki dojazd.',
    'Na {place} szukałem „kogoś lokalnego”. Wziąłem INNSER — i dobrze. Holownik konkretny.',
