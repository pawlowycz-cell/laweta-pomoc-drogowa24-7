...
const LOCALES = {
  ...
  uk: {
    ...
    keywords:
      'дешевий евакуатор варшава, евакуатор варшава, евакуатор варшава 24/7, замовити евакуатор варшава, недорогий евакуатор варшава, лафета варшава, допомога на дорозі варшава, INNSER',
