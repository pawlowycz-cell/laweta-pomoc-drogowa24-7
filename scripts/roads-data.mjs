...
const COPY = {
  ...
  ru: {
    ...
    seoTitle: (n) => `${n} | INNSER`,
    seoDesc: (n) =>
      `${n} у Варшавы: помощь 24/7, приезд ~30 мин. Эвакуатор и лавета — на страницах услуг. INNSER: 506-001-057.`,
    indexSeoTitle: 'Трассы у Варшавы | INNSER',
    indexSeoDesc:
      'Трассы вокруг Варшавы — A2, S2, S7, S8, S17, DK50. Услуги: /ru/ и /ru/svc6/. INNSER 24/7.',
  },
  ua: {
    h1: (n) => n,
    intro: (n, f) =>
    ...
    seoTitle: (n) => `${n} | INNSER`,
    seoDesc: (n) =>
      `${n} біля Варшави: допомога 24/7, приїзд ~30 хв. Евакуатор і лафета — на сторінках послуг. INNSER: 506-001-057.`,
    indexSeoTitle: 'Траси біля Варшави | INNSER',
    indexSeoDesc:
      'Траси навколо Варшави — A2, S2, S7, S8, S17, DK50. Послуги: /uk/ і /uk/svc6/. INNSER 24/7.',
  },
};
