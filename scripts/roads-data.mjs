...
const COPY = {
  ...
  ru: {
    h1: (n) => `Лавета на ${n} — помощь 24/7 | Варшава`,
    intro: (n, f) =>
    ...
    indexTitle: 'Лавета на трассах у Варшавы',
    ...
    seoTitle: (n) => `Лавета на ${n} — помощь 24/7 | INNSER`,
    seoDesc: (n) =>
      `Лавета и эвакуатор на ${n} у Варшавы 24/7. От 250 zł, приезд ~30 мин. INNSER: 506-001-057.`,
    indexSeoTitle: 'Лавета на трассах у Варшавы — A2 S2 S7 S8 24/7 | INNSER',
    indexSeoDesc:
