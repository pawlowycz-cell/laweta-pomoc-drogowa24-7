...
const COPY = {
  ...
  ru: {
    h1: (n) => n,
    intro: (n, f) =>
      `INNSER на трассе ${n}. Знаем ${f}. Приезд обычно 20–40 минут, круглосуточно.`,
    p2: (n) =>
    ...
    linkLaweta: (n) => n,
    indexTitle: 'Трассы у Варшавы',
    indexDesc: 'INNSER на A2, S2, S7, S8, S17, S79, DK7, DK8, DK17, DK50 и окружной Варшавы. Выберите трассу — приезд 24/7.',
    seoTitle: (n) => `${n} — трасса у Варшавы 24/7 | INNSER`,
    seoDesc: (n) =>
      `${n}: помощь на трассе 24/7, приезд ~30 мин. Эвакуатор: /ru/ и /ru/svc1/. Лавета Варшава: /ru/svc6/. INNSER: 506-001-057.`,
    indexSeoTitle: 'Трассы у Варшавы | INNSER',
    indexSeoDesc:
      'Трассы вокруг Варшавы — A2, S2, S7, S8, S17, DK50. Эвакуатор: /ru/ и /ru/svc1/. Лавета Варшава: /ru/svc6/. INNSER 24/7.',
  },
  ua: {
    h1: (n) => n,
    intro: (n, f) =>
      `INNSER на трасі ${n}. Знаємо ${f}. Приїзд зазвичай 20–40 хвилин, цілодобово.`,
    p2: (n) =>
    ...
    linkLaweta: (n) => n,
    indexTitle: 'Траси біля Варшави',
    indexDesc: 'INNSER на A2, S2, S7, S8, S17, S79, DK7, DK8, DK17, DK50 та об’їзній Варшави. Оберіть трасу — приїзд 24/7.',
    seoTitle: (n) => `${n} — траса біля Варшави 24/7 | INNSER`,
    seoDesc: (n) =>
      `${n}: допомога на трасі 24/7, приїзд ~30 хв. Евакуатор: /uk/ і /uk/svc1/. Лафета Варшава: /uk/svc6/. INNSER: 506-001-057.`,
    indexSeoTitle: 'Траси біля Варшави | INNSER',
    indexSeoDesc:
      'Траси навколо Варшави — A2, S2, S7, S8, S17, DK50. Евакуатор: /uk/ і /uk/svc1/. Лафета Варшава: /uk/svc6/. INNSER 24/7.',
  },
};
