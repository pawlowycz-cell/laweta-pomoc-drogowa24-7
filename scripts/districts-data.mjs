...
const COPY = {
  ...
  ru: {
    h1: (n, kind) =>
      isSuburb(kind)
        ? `Лавета ${n} — помощь на дороге 24/7`
        : `Лавета ${n} — район Варшавы 24/7`,
    intro: (n, f) =>
      `INNSER — лавета в ${n}. Знаем ${f}. Приезд обычно 20–30 минут, круглосуточно.`,
    p2: (n) =>
      `Эвакуация, прикур, замена колеса и открытие авто в ${n}. Цена согласована заранее. Звоните: 506-001-057.`,
    svc: 'Наши услуги в Варшаве',
    near: (n) => `Также обслуживаем соседние районы рядом с ${n}:`,
    linkLaweta: (n) => `Лавета ${n}`,
    indexTitle: 'Лавета по районам Варшавы и пригородам',
    ...
    seoTitle: (n, kind) =>
      isSuburb(kind)
        ? `Лавета ${n} — пригород 24/7 | INNSER`
        : `Лавета ${n} — район 24/7 | INNSER`,
    seoDesc: (n, kind) =>
      isSuburb(kind)
        ? `Помощь на дороге в ${n}: лавета, приезд ~30 мин. Городской эвакуатор — на главной. INNSER: 506-001-057.`
        : `Помощь на дороге в районе ${n}: лавета, приезд ~30 мин. Эвакуатор по всей Варшаве — на главной. INNSER: 506-001-057.`,
    indexSeoTitle: 'Районы Варшавы — лавета по районам 24/7 | INNSER',
    indexSeoDesc:
      'Лавета по районам Варшавы — Мокотув, Воля, Прага, Урсынув. Городской эвакуатор: warszawa-laweta.com/ru/. INNSER 24/7.',
    citywideHtml: (seg) =>
      `<p class="dist-citywide">Нужен <a href="/${seg}/"><strong>эвакуатор Варшава 24/7</strong></a> по всему городу? Откройте главную или <a href="/${seg}/svc1/"><strong>заказать эвакуатор в Варшаве</strong></a>. Эта страница — только район.</p>`,
  },
  ua: {
    h1: (n, kind) =>
      isSuburb(kind)
    ...
    intro: (n, f) =>
      `INNSER — лавета у ${n}. Знаємо ${f}. Приїзд зазвичай 20–30 хвилин, цілодобово.`,
    p2: (n) =>
      `Евакуація, прикур, заміна колеса та відкриття авто в ${n}. Ціна домовлена наперед. Телефон: 506-001-057.`,
    ...
    seoTitle: (n, kind) =>
      isSuburb(kind)
        ? `Лавета ${n} — передмістя 24/7 | INNSER`
        : `Лавета ${n} — район 24/7 | INNSER`,
    seoDesc: (n, kind) =>
      isSuburb(kind)
        ? `Допомога на дорозі в ${n}: лавета, приїзд ~30 хв. Міський евакуатор — на головній. INNSER: 506-001-057.`
        : `Допомога на дорозі в районі ${n}: лавета, приїзд ~30 хв. Евакуатор по всій Варшаві — на головній. INNSER: 506-001-057.`,
    indexSeoTitle: 'Райони Варшави — лавета по районах 24/7 | INNSER',
    indexSeoDesc:
      'Лавета по районах Варшави — Мокотув, Воля, Прага, Урсинув. Міський евакуатор: /uk/. INNSER 24/7.',
    citywideHtml: (seg) =>
      `<p class="dist-citywide">Потрібен <a href="/${seg}/"><strong>евакуатор Варшава 24/7</strong></a> по всьому місту? Відкрийте головну або <a href="/${seg}/svc1/"><strong>замовити евакуатор у Варшаві</strong></a>. Ця сторінка — лише район.</p>`,
  },
};
...
export function renderDistrictStaticHtml(lang, slug, localePathSeg) {
  ...
  const citywide = typeof c.citywideHtml === 'function' ? c.citywideHtml(seg) : '';
