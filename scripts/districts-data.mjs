...
const COPY = {
  ...
  ru: {
    ...
    seoDesc: (n) =>
      `Помощь на дороге в районе ${n} — приезд ~30 мин, 24/7. Разговариваем на русском. Эвакуатор: /ru/ и /ru/svc1/. Лавета Варшава: /ru/svc6/. INNSER: 506-001-057.`,
    indexSeoTitle: 'Районы Варшавы и пригороды | INNSER',
    indexSeoDesc:
      'Районы и пригороды Варшавы — Мокотув, Воля, Прага, Урсынув. Эвакуатор: /ru/ и /ru/svc1/. Лавета Варшава: /ru/svc6/. INNSER 24/7.',
    citywideHtml: (seg) =>
      `<p class="sd">Нужна <a href="/${seg}/svc6/"><strong>лавета Варшава</strong></a> по городу? Платформа 24/7 — от 250 зл.</p>`,
  },
  ua: {
    h1: (n) => n,
    intro: (n, f) =>
    ...
    seoDesc: (n) =>
      `Допомога на дорозі в районі ${n} — приїзд ~30 хв, 24/7. Розмовляємо українською. Евакуатор: /uk/ і /uk/svc1/. Лафета Варшава: /uk/svc6/. INNSER: 506-001-057.`,
    indexSeoTitle: 'Райони Варшави та передмістя | INNSER',
    indexSeoDesc:
      'Райони та передмістя Варшави — Мокотув, Воля, Прага, Урсинув. Евакуатор: /uk/ і /uk/svc1/. Лафета Варшава: /uk/svc6/. INNSER 24/7.',
    citywideHtml: (seg) =>
      `<p class="sd">Потрібна <a href="/${seg}/svc6/"><strong>лафета Варшава</strong></a> містом? Платформа 24/7 — від 250 зл.</p>`,
  },
};
