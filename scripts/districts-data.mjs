...
const COPY = {
  ...
  ru: {
    h1: (n) => `${n} — Эвакуатор рядом 24/7 — Разговариваем на Русском`,
    intro: (n, f) =>
      `INNSER в ${n}. Знаем ${f}. Приезд обычно 20–30 минут, круглосуточно.`,
    p2: (n) =>
    ...
    linkLaweta: (n) => n,
    indexTitle: 'Районы Варшавы и пригороды',
    indexDesc: 'INNSER в районах Варшавы и пригородах (Зомбки, Марки, Отвоцк, Прушкув, Пясечно…). Выберите свой — приезд 24/7.',
    seoTitle: (n) => `${n} — Эвакуатор рядом 24/7 — Разговариваем на Русском | INNSER`,
    seoDesc: (n) =>
      `${n} — эвакуатор рядом 24/7. Разговариваем на Русском. Приезд ~30 мин, 24/7. INNSER: 506-001-057.`,
    indexSeoTitle: 'Районы Варшавы и пригороды | INNSER',
    indexSeoDesc:
      'Районы и пригороды Варшавы — Мокотув, Воля, Прага, Урсынув. Услуги: /ru/ и /ru/svc6/. INNSER 24/7.',
    citywideHtml: (seg) =>
      `<p class="dist-citywide">По всему городу: <a href="/${seg}/">эвакуатор Варшава</a>, <a href="/${seg}/svc1/">заказ эвакуатора</a>, <a href="/${seg}/svc6/">лавета</a>. Эта страница — только район.</p>`,
  },
  ua: {
    h1: (n) => `${n} — Евакуатор поруч 24/7 — Розмовляємо Українською`,
    intro: (n, f) =>
      `INNSER у ${n}. Знаємо ${f}. Приїзд зазвичай 20–30 хвилин, цілодобово.`,
    p2: (n) =>
    ...
    linkLaweta: (n) => n,
    indexTitle: 'Райони Варшави та передмістя',
    indexDesc: 'INNSER у районах Варшави та передмістях (Зомбки, Маркі, Отвоцьк, Прушкув, Пясечно…). Оберіть свій — приїзд 24/7.',
    seoTitle: (n) => `${n} — Евакуатор поруч 24/7 — Розмовляємо Українською | INNSER`,
    seoDesc: (n) =>
      `${n} — евакуатор поруч 24/7. Розмовляємо Українською. Приїзд ~30 хв, 24/7. INNSER: 506-001-057.`,
    indexSeoTitle: 'Райони Варшави та передмістя | INNSER',
    indexSeoDesc:
      'Райони та передмістя Варшави — Мокотув, Воля, Прага, Урсинув. Послуги: /uk/ і /uk/svc6/. INNSER 24/7.',
    citywideHtml: (seg) =>
      `<p class="dist-citywide">По всьому місту: <a href="/${seg}/">евакуатор Варшава</a>, <a href="/${seg}/svc1/">замовити евакуатор</a>, <a href="/${seg}/svc6/">лафета</a>. Ця сторінка — лише район.</p>`,
  },
};
