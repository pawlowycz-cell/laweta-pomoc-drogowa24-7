...
const COPY = {
  ...
  ru: {
    ...
    seoTitle: (n, kind) =>
      isSuburb(kind)
        ? `Лавета ${n} — пригород Варшавы 24/7 | INNSER`
        : `Лавета ${n} — район Варшавы 24/7 | INNSER`,
    seoDesc: (n, kind) =>
      isSuburb(kind)
        ? `Лавета и эвакуатор в ${n} 24/7. Эвакуация от 250 zł, приезд ~30 мин. INNSER: 506-001-057.`
        : `Лавета и эвакуатор в районе ${n}, Варшава 24/7. Эвакуация от 250 zł, приезд ~30 мин. INNSER: 506-001-057.`,
    indexSeoTitle: 'Районы Варшавы — лавета и помощь 24/7 | INNSER',
    indexSeoDesc:
      'Лавета и помощь на дороге в районах Варшавы — Мокотув, Воля, Прага, Урсынув и другие. INNSER 24/7, 506-001-057.',
  },
  ua: {
    h1: (n, kind) =>
      isSuburb(kind)
